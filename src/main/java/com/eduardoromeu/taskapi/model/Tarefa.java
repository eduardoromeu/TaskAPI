package com.eduardoromeu.taskapi.model;
...
public class Tarefa {
	...
	public void setDataEntrega(LocalDate email) {
		this.dataEntrega = email;
	}
	public String getResponsavel() {
		return responsavel;
	}
	public void setResponsavel(String fone) {
		this.responsavel = fone;
	}
